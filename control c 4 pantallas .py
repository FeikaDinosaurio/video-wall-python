...
# Controles para cambiar entre pantallas
change_screen_key = ord('c')  # Cambiar entre pantallas usando la tecla 'c'
...
while True:
    ...
    if key == change_screen_key:
        current_screen = chr(ord(current_screen) + 1) if current_screen < 'd' else 'a'
